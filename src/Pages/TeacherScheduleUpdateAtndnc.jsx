...
class TeacherScheduleUpdateAtndnc extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="container">
        ...
        <h1 className="text-dark heading_biit"> Welcome! {localStorage.getItem('Name')} To Your Classes Schedule  Update Attendance </h1>
          ...
          <table className="table table-hover table-light table_bordered_custom">
            ...
            <thead className="thead-dark">
              <tr>  {/* ShowSchedule_Arr[1] will show Current Day */}
                ...
                <th> {"Date: " + localStorage.getItem("SelectedDateForUpdatingAtndnc")} </th>
              </tr>
...
export default TeacherScheduleUpdateAtndnc;